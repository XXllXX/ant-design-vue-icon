<template>
  <div>
    <div class="toolbar">
      <a-radio-group :value="theme" @change="handleThemeChange" class="">
...
export default {
  ...
  methods: {
    ...
    getThemeIcons() {
      if (this.theme == 'gold')
        this.iconList = Object.values(this.icons).filter((t) => t)
      else
        this.iconList = Object.values(this.icons).filter(
